<footer class="bg12">
    <div class="bg-img2 p-b-74" style="background-image: url(client/new/images/icons/symbol-36.png);">
        <div class="container">
                        ...
                        <li class="txt-s-101 cl6 flex-t p-b-10">
                            ...
                            <span class="size-w-12 p-t-1">
                                    <a href="https://freebw.com/cdn-cgi/l/email-protection" class="__cf_email__"
                                       data-cfemail="85e8e4f7eef7f0f6f6e0e9e9c5e0fde4e8f5e9e0abe6eae8">[email&#160;protected]</a>
                                </span>
                        </li>
                        <li class="txt-s-101 cl6 flex-t p-b-10">
                                <span class="size-w-11">
                ...
                <div class="footer-col4 p-b-50">
                    ...
                    <form class="flex-w">
                        ...
                        <button class="flex-c-m size-a-10 bg10 hov-btn2 trans-04">
                            <img src="client/new/images/icons/icon-send.png" alt="SENT">
                        </button>
                    </form>
                </div>
            </div>
